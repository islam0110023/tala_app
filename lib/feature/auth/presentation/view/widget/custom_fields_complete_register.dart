...
class CustomFieldsCompleteRegister extends StatelessWidget {
  const CustomFieldsCompleteRegister({
    super.key, required this.yourNameController, required this.lastNameController, required this.phoneNumberController,
  });
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: AppDimensions.h18),
        CustomTextField(hint: LocaleKeys.phoneNumber.tr()
        ,textInputType: TextInputType.phone,controller: phoneNumberController),
        SizedBox(height: AppDimensions.h18),
      ],
    );
  }
